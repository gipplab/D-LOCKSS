...
func (m *MockIPFSClient) ImportFile(ctx context.Context, filePath string) (cid.Cid, error) { return cid.Cid{}, nil }
func (m *MockIPFSClient) ImportReader(ctx context.Context, reader io.Reader) (cid.Cid, error) { return cid.Cid{}, nil }
func (m *MockIPFSClient) PutDagCBOR(ctx context.Context, block []byte) (cid.Cid, error) { return cid.Cid{}, nil }
func (m *MockIPFSClient) GetBlock(ctx context.Context, blockCID cid.Cid) ([]byte, error) { return nil, nil }
...
func (m *MockIPFSClient) VerifyDAGCompleteness(ctx context.Context, rootCID cid.Cid) (bool, error) { return true, nil }
...
// MockDHTProvider implements common.DHTProvider
type MockDHTProvider struct{}
func (m *MockDHTProvider) FindProvidersAsync(ctx context.Context, key cid.Cid, count int) <-chan peer.AddrInfo { return nil }
func (m *MockDHTProvider) Provide(ctx context.Context, key cid.Cid, broadcast bool) error { return nil }
func (m *MockDHTProvider) FindPeer(ctx context.Context, id peer.ID) (peer.AddrInfo, error) { return peer.AddrInfo{}, nil }
...
func TestSplitShard_NoDeadlock(t *testing.T) {
	...
	sm := NewShardManager(ctx, h, ps, ipfsClient, storageMgr, metrics, nil, nil, "")

	// Register shard info with metrics to simulate production setup
	metrics.RegisterProviders(sm, storageMgr, nil, nil)
