...
(
  ...
  DLOCKSS_REPLICATION_WORKERS=2 \
  DLOCKSS_MAX_CONCURRENT_CHECKS=2 \
  DLOCKSS_MAX_CONCURRENT_FILE_PROCESSING=2 \
  DLOCKSS_PIPELINE_PROBER_WORKERS=10 \
  DLOCKSS_DHT_QUERY_TIMEOUT=60s \
  DLOCKSS_CHECK_INTERVAL=2m \
  DLOCKSS_SHARD_PEER_CHECK_INTERVAL=60s \
